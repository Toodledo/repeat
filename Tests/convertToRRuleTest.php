<?php
	...
	{	
		...
		{   
			$converted = rep_normalize(1,"",true);
			$this->assertEquals("FREQ=WEEKLY", $converted );
			$converted = rep_normalize(101,"",true);
			$this->assertEquals("FREQ=WEEKLY;FROMCOMP", $converted );

			$converted = rep_normalize(9,"",true);
			$this->assertEquals("PARENT", $converted );
			$converted = rep_normalize(109,"",true);
			$this->assertEquals("PARENT;FROMCOMP", $converted );

			$converted = rep_normalize(50,"Every 2 weeks",true);
			$this->assertEquals("FREQ=WEEKLY;INTERVAL=2", $converted );
			$converted = rep_normalize(150,"Every 2 weeks",true);
			$this->assertEquals("FREQ=WEEKLY;INTERVAL=2;FROMCOMP", $converted );

			$converted = rep_normalize(50,"With Parent",true);
			$this->assertEquals("PARENT", $converted );
			$converted = rep_normalize(150,"With Parent",true);
			$this->assertEquals("PARENT;FROMCOMP", $converted );

			$converted = rep_normalize(60,"FREQ=WEEKLY;INTERVAL=2",true);
			$this->assertEquals("FREQ=WEEKLY;INTERVAL=2", $converted );
			$converted = rep_normalize(160,"FREQ=WEEKLY;INTERVAL=2;FROMCOMP",true);
			$this->assertEquals("FREQ=WEEKLY;INTERVAL=2;FROMCOMP", $converted );
