	...
	class GetNextDateTests extends PHPUnit_Framework_TestCase
	{
		...
		*/
		public function test_BadParams()
		{
			...
			$this->assertEquals( floor($newdue/10), floor($array[1]/10) );
		...
		*/
		...
		public function test_UnixTimestamp_SimpleDaily40()
		{
			...
			$newstart = 0;
			$newdue = 1328860800;//new DateTime("February 10, 2012");
		...
		public function test_UnixTimestamp_SimpleWeekly()
		{
			...
			$newstart = 0;
			$newdue = 1326614400;//new DateTime("January 15, 2012");
		...
		public function test_UnixTimestamp_SimpleYearly()
		{
			...
			$newstart = 0;
			$newdue = 1357027200;//new DateTime("January 1, 2013");
		...
		public function test_SimpleDaily_FromStartNegativeDue()
		{
			$ical = "FREQ=DAILY;INTERVAL=1";
		...
		*/
		...
		public function test_FastFoward_WeeklyByDay_Every()
		{
			...
			$start = 1357459200;//new DateTime("January 6, 2010");
			$due = 1357632000;//new DateTime("January 8, 2010");
			$comp = 0;

			$newdue = new DateTime(date('Y-m-d H:i:s', strtotime('next Tuesday GMT 8am ')));
			$newstart = $newdue->getTimestamp()-86400*2;
